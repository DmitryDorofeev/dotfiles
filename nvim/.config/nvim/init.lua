...
-- Diagnostic keymaps
vim.keymap.set('n', '<leader>cd', vim.diagnostic.setloclist, { desc = 'Open [C]ode [D]iagnostic for file' })
vim.keymap.set('n', '<leader>cD', vim.diagnostic.setqflist, { desc = 'Open [C]ode [D]iagnostic for project' })
...
require('lazy').setup({
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('gcr', require('telescope.builtin').lsp_references, '[G]oto [R]eferences')

          -- Jump to the implementation of the word under your cursor.
          --  Useful when your language has ways of declaring types without an actual implementation.
          map('gci', require('telescope.builtin').lsp_implementations, '[G]oto [I]mplementation')
      ...
      vim.list_extend(ensure_installed, {
        ...
        'eslint_d', -- Used to format TypeScript/TSX code
      })
      ...
      formatters = {
        eslint_d = {
          ...
          format = function(result)
            ...
            if not ok or not decoded[1] or not decoded[1].output then
              return result.stdout
            end
            return decoded[1].output
          end,
        },
      },
    },
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ensure_installed = { 'bash', 'c', 'diff', 'html', 'lua', 'go', 'dart', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc' },
